...
Copyright (C) 2024 Gamebuster1990
lar@quicklz.com
...
┌───────────────────────────────────┐
│                                   │
│ Begin Modifications by Gamebuster │
│                                   │
└───────────────────────────────────┘
*/
...
void printHelp() {
	...
	puts("=================================");
	puts("| equicklz help");
	puts("|   Description: Prints this help message");
	puts("|================================");
	puts("| equicklz <mode> <input> <dest>");
	puts("|   Description: Compresses or decompresses the provided input file using quicklz. The destination is the newly created file.");
	puts("|   Arguments:");
	puts("|     <mode>");
	puts("|       -c compress mode - compresses the input to the destination.");
	puts("|       -d decompress mode - decompresses the input to the destination.");
...
void doDecompress(FILE* ifile, FILE* ofile) {
	char *src, *dst;
	unsigned int len;
